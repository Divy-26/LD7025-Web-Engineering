...
<body>
	...
	<hr />
	   ...
	   <select name="street" class="cjComboBox" >
			<option value="Liverpool street 1">Liverpool street 1- Cars Only</option>
			<option value="Liverpool street 2">Liverpool street 2 - Scooters,Bikes and Cars</option>
	...
	<input type="text" name="account" placeholder="Card Number" required title="Credit card number" maxlength="14"/> 
	   ...
	   <label>Note: Parking Fees: 6£ per hour</label>
	</fieldset>
	<footer>
